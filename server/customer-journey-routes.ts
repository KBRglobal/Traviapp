...
export function registerCustomerJourneyRoutes(app: Express) {
  ...
  // Track CTA click
  // -------------------------------------------------------------------------
  app.post("/api/analytics/cta", async (req: Request, res: Response) => {
    try {
      const {
        sessionId,
        visitorId,
  ...
  // Track scroll depth
  // -------------------------------------------------------------------------
  app.post("/api/analytics/scroll", async (req: Request, res: Response) => {
    try {
      const {
        sessionId,
        visitorId,
  ...
  // -------------------------------------------------------------------------
  app.get("/api/analytics/journey/:visitorId", async (req: Request, res: Response) => {
    try {
  ...
  // -------------------------------------------------------------------------
  app.post("/api/analytics/funnel", async (req: Request, res: Response) => {
    try {
  ...
  // -------------------------------------------------------------------------
  app.get("/api/analytics/heatmap/*", async (req: Request, res: Response) => {
    try {
