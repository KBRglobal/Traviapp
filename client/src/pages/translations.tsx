    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-muted-foreground">Manage content translations across 17 languages</p>
        </div>
        ...
        <TabsContent value="content" className="space-y-4">
          <Card>
            <CardHeader>
              ...
              <CardDescription>View and manage translations for each content item</CardDescription>
            </CardHeader>
            <CardContent>
              {contentsLoading ? (
                ...
                <Table>
                  ...
                  <TableBody>
                    {publishedContents.slice(0, 20).map((content) => {
                      const status = getTranslationStatus(content.id);
                      const isTranslating = translatingContent === content.id;
                        ...
                        <TableRow key={content.id}>
                          ...
                          <TableCell className="text-right">
                            <Button
                              ...
                              onClick={() => handleTranslateContent(content.id, status?.pendingLocales || [])}
                              data-testid={`button-translate-${content.id}`}
                            >
                              {isTranslating ? (
