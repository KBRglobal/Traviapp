...
export default function PrivacyPolicy() {
  ...
  const hasContent = page?.content || (locale === 'he' && page?.contentHe);
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          {isLoading ? (
            ...
            >
              ...
              <div dangerouslySetInnerHTML={{ __html: DOMPurify.sanitize(getHtmlContent()) }} />
            </article>
          ) : (
            <div className="text-center py-20">
              <Shield className="w-16 h-16 mx-auto mb-4 text-muted-foreground/50" />
              ...
              <p className="text-muted-foreground">
                {locale === 'he' 
                  ...
                  : 'This page content has not been added yet.'}
              </p>
            </div>
          )}
        </div>
