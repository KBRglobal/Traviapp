      ...
      <div className="max-w-7xl mx-auto px-5 md:px-8 lg:px-[140px]">
        ...
        >
          ...
          <h2 className="font-heading text-3xl md:text-4xl lg:text-5xl font-bold text-foreground mb-4">
            Find Your <span className="bg-gradient-to-r from-orange-500 to-red-500 bg-clip-text text-transparent">Flavor</span>
          </h2>
            ...
            return (
              <motion.button
                ...
                className={cn(
                  ...
                  "border-2",
                  isSelected 
                    ? `bg-gradient-to-br ${craving.gradient} border-transparent shadow-xl`
                    : "bg-card border-border/50 hover:border-orange-500/50"
                )}
              ...
              >
                <motion.div 
                  className={cn(
                    ...
                    isSelected 
                      ? "bg-white/20" 
                      : `bg-gradient-to-br ${craving.gradient}`
                  )}
                >
                ...
                <h3 className={cn(
                  "font-heading font-bold text-base md:text-lg mb-1",
      ...
      <div className="max-w-7xl mx-auto px-5 md:px-8 lg:px-[140px]">
        ...
        >
          ...
          <h2 className="font-heading text-3xl md:text-4xl font-bold text-foreground mb-4">
            Unique <span className="text-violet-500">Dining Experiences</span>
          </h2>
                ...
                <Card className="group overflow-hidden hover-elevate">
                  <div className="relative aspect-[16/10] overflow-hidden">
                    ...
                    <div className="absolute bottom-0 left-0 right-0 p-5">
                      <h3 className="font-heading text-xl font-bold text-white mb-1">{experience.name}</h3>
        ...
        >
          {[...todaysSpecials, ...todaysSpecials].map((special, i) => (
            <div key={i} className="flex items-center gap-4">
              ...
              <span className="font-bold text-amber-300">{special.price}</span>
            </div>
          ))}
        </motion.div>
      </div>
