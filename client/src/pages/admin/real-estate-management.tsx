...
const CATEGORY_INFO = {
  guide: { 
    label: "Guides", 
    icon: BookOpen, 
    description: "Investment guides, how-to articles, and educational content",
    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between gap-4 flex-wrap">
        <div>
          ...
          <p className="text-muted-foreground">Edit content on investment guides, calculators, comparisons, and case studies</p>
        </div>
        ...
        <Card>
          <CardContent className="py-12 text-center">
            ...
            <p className="text-muted-foreground mb-4">
              ...
              This will allow you to edit content, hero text, FAQs, and more.
            </p>
            <Button 
              onClick={() => seedMutation.mutate()} 
              disabled={seedMutation.isPending}
                              ...
                              <div className="flex items-center gap-3 min-w-0 flex-1">
                                ...
                                <div className="min-w-0 flex-1">
                                  ...
                                  <p className="text-xs text-muted-foreground truncate">
                                    {page.heroTitle || page.metaTitle || "No custom content yet"}
                                  </p>
                                </div>
                              </div>
          ...
          <Card>
            ...
            <CardContent>
              <div className="space-y-4 text-sm text-muted-foreground">
                <p>
                  <strong>CMS Overrides:</strong> Each page has a static React component with default content.
                  When you edit a page through this interface, your changes override the defaults - allowing you
                  to customize hero titles, intro text, FAQs, and section content.
                </p>
                <p>
