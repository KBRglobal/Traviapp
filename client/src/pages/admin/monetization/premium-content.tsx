...
export default function PremiumContentPage() {
  ...
  const { data: premiumContent } = useQuery<any[]>({
    queryKey: ["/api/monetization/premium/content"],
  });
  ...
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-3xl font-bold flex items-center gap-3" data-testid="heading-premium-content">
          <Crown className="h-8 w-8 text-primary" />
          Premium Content
        </h1>
        <p className="text-muted-foreground mt-1">
          Manage paid content, subscriptions, and access control
        </p>
        <div className="mt-4 p-4 bg-muted/50 rounded-lg border">
          ...
          <p className="text-sm text-muted-foreground">
            Mark content as <strong>premium</strong> to require payment before access. 
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Toggle premium status and configure pricing for your content
          </CardDescription>
        </CardHeader>
        <CardContent>
          <ScrollArea className="h-[400px]">
            {premiumContent?.length ? (
              ...
              <div className="text-center py-12 text-muted-foreground">
                ...
                <p>No premium content configured yet</p>
                <p className="text-sm">Mark articles as premium in the content editor</p>
              </div>
            )}
          </ScrollArea>
        </CardContent>
