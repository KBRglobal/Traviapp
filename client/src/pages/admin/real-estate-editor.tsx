        ...
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-sm text-muted-foreground">
              Edit content, SEO settings, and FAQs for this page
            </p>
          </div>
        </div>
        <div className="flex items-center gap-2">
            ...
            <TabsContent value="content" className="mt-6 space-y-6">
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>
                    Edit the main content displayed on this page
                  </CardDescription>
                </CardHeader>
                ...
                <CardContent className="space-y-4">
                  {faqFields.length === 0 ? (
                    ...
                    faqFields.map((field, index) => (
                      <Card key={field.id} className="bg-muted/30" data-testid={`card-faq-${index}`}>
                ...
                <CardContent className="space-y-4">
                  {linkFields.length === 0 ? (
                    ...
                    linkFields.map((field, index) => (
                      <Card key={field.id} className="bg-muted/30" data-testid={`card-link-${index}`}>
                        <CardContent className="pt-4">
                          <div className="flex items-start gap-4">
                            <div className="flex-1 space-y-4">
                              <div className="grid gap-4 md:grid-cols-2">
