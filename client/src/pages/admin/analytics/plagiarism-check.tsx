    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-muted-foreground mt-1">
            Ensure content originality and avoid duplicate content issues
          </p>
        </div>
        <Button 
      ...
      <div className="p-4 bg-muted/50 rounded-lg border">
        ...
        <p className="text-sm text-muted-foreground">
          Plagiarism check scans your content against <strong>web sources and internal duplicates</strong>.
          Ensures AI-generated articles are unique and flags content that may hurt SEO rankings.
          <br />
