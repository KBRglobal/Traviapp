    ...
    <div className="space-y-6">
      ...
      <div className="p-4 bg-muted/50 rounded-lg border">
        ...
        <p className="text-sm text-muted-foreground">
          Semantic search uses <strong>AI embeddings</strong> to understand the meaning of your content.
          Find related articles even if they don't share exact keywords. 
          Automatically suggest internal links and discover content gaps.
          <br />
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Try a natural language search across your content
          </CardDescription>
        </CardHeader>
        <CardContent>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Automatically discovered connections between your content
          </CardDescription>
        </CardHeader>
        <CardContent>
          <ScrollArea className="h-[300px]">
            {relatedContent?.length ? (
              ...
              <div className="text-center py-8 text-muted-foreground">
                ...
                <p>No content relationships detected</p>
                <p className="text-sm">Index your content to discover connections</p>
              </div>
            )}
          </ScrollArea>
        </CardContent>
