...
export default function CustomerJourneyPage() {
  ...
  const { data: content } = useQuery<ContentPerformance[]>({
    queryKey: ["/api/analytics/journey/content"],
  });
    ...
    <div className="space-y-6">
      <div>
        ...
        <p className="text-muted-foreground mt-1">
          Understand how visitors navigate your content
        </p>
        <div className="mt-4 p-4 bg-muted/50 rounded-lg border">
          ...
          <p className="text-sm text-muted-foreground">
            Track the <strong>path visitors take</strong> through your content. See which articles lead to bookings,
            identify drop-off points, and optimize your content funnel for maximum conversions.
            <br />
            ...
            <ScrollArea className="h-[350px]">
              {paths?.length ? (
                ...
                <div className="text-center py-8 text-muted-foreground">
                  ...
                  <p className="text-sm">Paths will appear as visitors navigate your content</p>
                </div>
              )}
            </ScrollArea>
          </CardContent>
                ...
                <div className="space-y-3">
                  {content.map((item) => (
                    <div
                      ...
                      data-testid={`journey-content-${item.contentId}`}
                    >
                      <div className="flex items-center justify-between">
