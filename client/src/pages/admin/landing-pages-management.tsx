    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between gap-4 flex-wrap">
        <div>
          ...
          <p className="text-muted-foreground">Manage special landing pages and informational content</p>
        </div>
        ...
        <TabsContent value="overview" className="space-y-6">
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                These are built-in landing pages with comprehensive content. They require code changes to update.
              </CardDescription>
            </CardHeader>
            <CardContent>
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                These are editable landing pages managed through the CMS. Create new pages for custom content.
              </CardDescription>
            </CardHeader>
            <CardContent>
              {cmsPages?.contents?.length ? (
                ...
                <div className="text-center py-8 text-muted-foreground">
                  ...
                  <p className="text-sm">Create custom landing pages for campaigns, promotions, or seasonal content.</p>
      ...
      <Card>
        ...
        <CardContent>
          <div className="space-y-4 text-sm text-muted-foreground">
            <p>
              <strong>Static Pages:</strong> Built-in pages with comprehensive, SEO-optimized content. 
              These pages (Free Things to Do, Dubai Laws, etc.) contain detailed information and require 
              code changes to update their content.
            </p>
            <p>
              <strong>CMS Pages:</strong> Create custom landing pages for campaigns, promotions, or 
              any special content. These are fully editable through the content editor with blocks, 
