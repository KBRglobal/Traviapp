    ...
    <div className="space-y-6">
      <div>
        ...
        <div className="mt-4 p-4 bg-muted/50 rounded-lg border">
          ...
          <p className="text-sm text-muted-foreground">
            Every action in the CMS is logged here: content edits, user logins, settings changes, and more.
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold text-blue-600" data-testid="text-content-changes">
