    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between gap-4 flex-wrap">
        <div>
          ...
          <p className="text-muted-foreground">Manage Dubai district guides and neighborhood content</p>
        </div>
        ...
        <TabsContent value="overview" className="space-y-6">
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Editable district content managed through the CMS. Create new district pages or additional content.
              </CardDescription>
            </CardHeader>
            <CardContent>
              {cmsDistricts?.contents?.length ? (
                ...
                <div className="text-center py-8 text-muted-foreground">
                  ...
                  <p className="text-sm">Create additional district content or sub-pages.</p>
      ...
      <Card>
        ...
        <CardContent>
          <div className="space-y-4 text-sm text-muted-foreground">
            ...
            <p>
              <strong>CMS Districts:</strong> Create additional district content or sub-pages through the CMS. 
              Fully editable with content blocks, images, and SEO settings.
            </p>
            <p>
