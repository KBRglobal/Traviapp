          ...
          <TabsContent key={category} value={category} className="space-y-4">
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  {pages.length} pages in this category. These are static pages with embedded content.
                </CardDescription>
              </CardHeader>
              <CardContent>
      ...
      <Card>
        ...
        <CardContent>
          <div className="space-y-4 text-sm text-muted-foreground">
            ...
            <p>
              To update content on static pages, code changes are required. For dynamic property listings, 
