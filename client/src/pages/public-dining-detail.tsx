...
export default function PublicDiningDetail() {
  ...
  useDocumentMeta({
    title: content ? `${content.title} | Dubai Restaurants | Travi` : "Restaurant | Travi",
    description: content?.metaDescription || "Discover exceptional dining in Dubai.",
  ...
  if (!content || content.type !== 'dining') {
    return (
      <div className="min-h-screen bg-background">
        <PublicNav />
            ...
            <div className="grid md:grid-cols-2 gap-8 items-center">
              <div>
                ...
                <p className="text-muted-foreground leading-relaxed">
                  {content.metaDescription || `Experience exceptional cuisine at ${content.title}, one of Dubai's premier dining destinations offering ${cuisineType.toLowerCase()} flavors in an unforgettable setting.`}
                </p>
              </div>
            ...
            <Card className="relative overflow-hidden bg-gradient-to-r from-orange-500 to-rose-500 border-0 p-8 md:p-12 text-center">
              ...
              <div className="relative z-10">
                ...
                <p className="text-white/90 mb-6 max-w-xl mx-auto">
                  Experience the exceptional cuisine and ambiance at {content.title}. Book now to secure your perfect dining experience.
                </p>
