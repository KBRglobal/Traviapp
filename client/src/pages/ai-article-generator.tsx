...
const inputTypeOptions = [
  ...
  { value: "title_rss", label: "From RSS Feed", description: "Include RSS content" },
      ...
      <div className="flex items-center justify-between gap-4">
        <div>
          ...
          <p className="text-muted-foreground">
            Generate SEO-optimized Dubai travel content using AI
          </p>
        </div>
      </div>
              ...
              {inputType === "title_rss" && (
                <div className="space-y-2">
                  ...
                  <Textarea
                    ...
                    placeholder="Paste RSS item content here..."
                    rows={4}
                    data-testid="input-rss-content"
                  />
                </div>
              )}
              ...
              <CardContent className="p-6">
                <div className="space-y-4">
                  ...
                  <p className="text-sm text-muted-foreground">
                    The AI is analyzing your input and creating SEO-optimized content. This may take 15-30 seconds.
                  </p>
