      ...
      <div className="max-w-7xl mx-auto px-5 md:px-8 lg:px-[140px]">
        ...
        >
          <h2 className="font-heading text-3xl md:text-4xl font-bold text-foreground mb-4">
            Featured <span className="text-travi-purple">Hotels</span>
          </h2>
...
export default function PublicHotels() {
  ...
  return (
    <CategoryTemplate
      categoryType="hotels"
      seoConfig={{
        title: "Dubai Luxury Hotels & Resorts 2025 | Beach, City & Family | Travi",
        description: "Find the perfect Dubai hotel - from iconic 7-star Burj Al Arab to beach resorts on Palm Jumeirah. Compare 500+ luxury hotels with exclusive deals."
      }}
    >
      <TrendingMarquee />
