    ...
    <div className="bg-background min-h-screen">
      ...
      <main className="pt-24 pb-16">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <Link href="/" className="inline-flex items-center gap-2 text-[#6443f4] hover:underline mb-6" data-testid="link-back-home">
            <ArrowLeft className="w-4 h-4" />
            Back to Home
          </Link>

          <article className="prose prose-lg dark:prose-invert max-w-none">
            <h1 data-testid="text-page-title">Terms & Conditions</h1>
            ...
            <h2>4. User Conduct & Prohibited Actions</h2>
            ...
            <h2>5. Intellectual Property & Limited License</h2>
            ...
            <h2>6. Notice-and-Takedown (DMCA/Similar)</h2>
            ...
            <h2>7. Accuracy, Availability & Disclaimers</h2>
            ...
            <h2>10. Privacy, Cookies & Data Protection</h2>
            <p>We describe our data practices in our <Link href="/privacy" className="text-[#6443f4]">Privacy Policy</Link>. In summary:</p>
            <ul>
            ...
            <h2>11. Accessibility Statement (WCAG 2.2)</h2>
            ...
            <h2>12. Governing Law, Arbitration & Jurisdiction</h2>
            ...
            <h2>13. Updates, Suspension & Termination</h2>
