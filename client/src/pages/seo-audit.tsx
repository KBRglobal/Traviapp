...
function analyzeSEO(content: ContentWithRelations): SEOIssue[] {
  ...
  if (wordCount < 300) {
    issues.push({ type: "error", category: "Content", message: "Content too thin (< 300 words)", field: "content" });
  ...
  // SEO score
  if (content.seoScore !== null && content.seoScore !== undefined && content.seoScore < 50) {
    issues.push({ type: "error", category: "Score", message: `Low SEO score (${content.seoScore}/100)`, field: "seoScore" });
  }
    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-muted-foreground">
            Analyze and improve SEO across all your content
          </p>
        </div>
      </div>
      ...
      <div className="grid gap-4 md:grid-cols-4">
        ...
        <Card>
          ...
          <CardContent>
            ...
            <p className="text-xs text-muted-foreground">
              {Math.round((stats.clean / stats.total) * 100) || 0}% of content
            </p>
          </CardContent>
        </Card>
      </div>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>How your content scores are distributed</CardDescription>
        </CardHeader>
        <CardContent>
        ...
        <CardHeader>
          <div className="flex items-center justify-between">
            <div>
              ...
              <CardDescription>Detailed SEO issues by content</CardDescription>
            </div>
