      ...
      <div className="max-w-7xl mx-auto px-5 md:px-8 lg:px-[140px]">
        ...
        >
          ...
          <h2 className="font-heading text-3xl md:text-4xl lg:text-5xl font-bold text-foreground mb-4">
            What's Your <span className="bg-gradient-to-r from-travi-purple to-travi-pink bg-clip-text text-transparent">Dubai Vibe?</span>
          </h2>
...
function DistrictStatsSection() {
  ...
  return (
    <section 
      className="py-16 bg-gradient-to-br from-travi-purple/10 via-travi-pink/10 to-travi-orange/10"
      ...
      <div className="max-w-7xl mx-auto px-5 md:px-8 lg:px-[140px]">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <motion.div 
            ...
            viewport={{ once: true }}
          >
            <Building className="w-10 h-10 text-travi-purple mx-auto mb-4" />
          ...
          >
            <UtensilsCrossed className="w-10 h-10 text-travi-orange mx-auto mb-4" />
            <div className="text-4xl font-bold text-foreground mb-2">
          ...
          >
            <MapPin className="w-10 h-10 text-travi-pink mx-auto mb-4" />
            <div className="text-4xl font-bold text-foreground mb-2">
