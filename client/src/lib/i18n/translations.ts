...
export const translations = {
  ...
  en: {
    ...
    offPlan: {
      metaTitle: "Buy Off-Plan Dubai: Crypto & Cash Payment Plans 2025",
  ...
  ar: {
    ...
    // Off-Plan Real Estate Page
    offPlan: {
      metaTitle: "شراء عقارات على الخارطة في دبي: خطط الدفع بالعملات المشفرة والنقد 2025",
  ...
  he: {
    ...
    // Off-Plan Real Estate Page
    offPlan: {
      metaTitle: "קנה נכס על הנייר בדובאי: תוכניות תשלום קריפטו ומזומן 2025",
