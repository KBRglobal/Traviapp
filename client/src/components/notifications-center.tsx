  ...
  const notifications = useMemo<Notification[]>(() => {
    ...
    if (attentionItems?.noViews?.length && attentionItems.noViews.length > 5) {
      items.push({
        ...
        description: "Published content with less than 10 views",
        time: now,
        link: "/admin/analytics",
      });
    }
    ...
    // Draft content that's been sitting for a while
    ...
    // In-review content waiting for approval
