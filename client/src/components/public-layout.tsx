...
export function Section({
  ...
  const variantClasses = {
    ...
    gradient: "bg-gradient-to-br from-travi-purple/5 via-travi-pink/5 to-travi-orange/5 dark:from-travi-purple/10 dark:via-travi-pink/10 dark:to-travi-orange/10",
  };
...
/* =============================================================================
   ContentCard - Unified card styling for content items
============================================================================= */
...
export function ContentCard({
  ...
  const cardContent = (
    <Card
      ...
      data-testid={`content-card-${title.toLowerCase().replace(/\s+/g, "-")}`}
    >
      {/* Image Container */}
      {image && (
        <div
          ...
          {badge && (
            <div className={cn(
              ...
              <Badge
                ...
                className="text-xs"
                data-testid="content-card-badge"
              >
                {badge}
              </Badge>
            </div>
      ...
      {/* Content */}
      <div className="p-5" data-testid="content-card-body">
        <h3
  ...
  if (href) {
    return (
      <Link
        ...
        className="block focus:outline-none focus-visible:ring-2 focus-visible:ring-travi-purple rounded-[16px]"
        data-testid={`content-card-link-${title.toLowerCase().replace(/\s+/g, "-")}`}
      >
        {cardContent}
      </Link>
    );
...
/* =============================================================================
   CategoryGrid - Responsive grid layout for content cards
============================================================================= */
