...
export function TraviRecommends({ recommendations, className = "" }: TraviRecommendsProps) {
  ...
  return (
    <section
      className={`py-16 lg:py-20 bg-gradient-to-br from-purple-50/50 via-pink-50/30 to-orange-50/30 dark:from-purple-950/20 dark:via-pink-950/10 dark:to-orange-950/10 ${className}`}
