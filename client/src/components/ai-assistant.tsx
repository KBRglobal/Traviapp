...
const suggestions: SuggestionChip[] = [
  ...
  },
  {
    ...
    prompt: "Create a content outline for a Dubai travel guide article",
  },
  {
    icon: Hash,
    label: "SEO keywords",
    prompt: "Suggest SEO keywords for Dubai tourism content",
  },
  {
    icon: PenLine,
    label: "Writing tips",
    prompt: "Give me tips for writing engaging travel content",
  },
];
          ...
          {messages.length === 0 ? (
            <div className="space-y-4">
              <p className="text-sm text-muted-foreground text-center">
                Hi! I'm your AI assistant. I can help you with content ideas,
