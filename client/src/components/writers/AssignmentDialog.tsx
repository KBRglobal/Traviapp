 ...
 * 
 * Dialog for assigning content to AI writers
 */
...
export function AssignmentDialog({ open, onOpenChange }: AssignmentDialogProps) {
  ...
  const { data: contentsData, isLoading: loadingContents } = useQuery({
    ...
    queryFn: async () => {
      ...
      // Filter to show only content without a writer assigned
      return {
        ...data,
    ...
    <Dialog open={open} onOpenChange={handleOpenChange}>
      <DialogContent className="max-w-3xl max-h-[80vh]">
        <DialogHeader>
          ...
          <DialogDescription>
            Assign content to an AI writer for generation
          </DialogDescription>
        </DialogHeader>
          ...
          <div className="space-y-2">
            ...
            <ScrollArea className="h-[300px] border rounded-md p-2">
              {loadingContents ? (
                ...
                <div className="text-center text-muted-foreground py-8">
                  No unassigned content available
                </div>
              ) : (
                <div className="space-y-2">
                  {contents.map((content) => (
                    <div
                      ...
                      data-testid={`content-option-${content.id}`}
                    >
          ...
          <div className="bg-muted/50 rounded-lg p-4">
            ...
            <div className="flex items-center gap-4 text-sm">
              ...
              <div className="flex items-center gap-2">
                ...
                <span>{selectedContent?.title || 'No content selected'}</span>
              </div>
            </div>
          </div>
        )}
